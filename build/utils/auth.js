...
const authUtils = {
    generateAccessToken(user) {
        return __awaiter(this, void 0, void 0, function* () {
            return jsonwebtoken_1.default.sign(user, jwtConfig.accessTokenSecret, {
                subject: user.id || '',
    ...
    generateRefreshToken(user) {
        return __awaiter(this, void 0, void 0, function* () {
            return jsonwebtoken_1.default.sign(user, jwtConfig.refreshTokenSecret, {
                subject: user.id || '',
                audience: jwtConfig.audience,
                issuer: jwtConfig.issuer,
                expiresIn: '1d',
    ...
    verifyJWT(token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return jsonwebtoken_1.verify(reToken, jwtConfig.accessTokenSecret, (err, user) => {
                if (err) {
                    throw err;
                }
                return user;
